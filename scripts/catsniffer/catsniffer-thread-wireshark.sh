...
echo "=== CatSniffer Thread Sniffer with Wireshark ==="
echo "Starting Thread sniffer on channel 15..."
echo ""

# Set up FIFO and launch Wireshark in background
FIFO_PATH="/tmp/fcatsniffer_thread_$$"
...
echo ""
/usr/bin/python3 cat_sniffer.py sniff /dev/ttyACM1 --phy thread -c 15 --fifo --fifo-name "$FIFO_PATH"
